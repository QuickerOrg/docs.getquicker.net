...
详细的面板整理规则见[动作面板常见问题](/v2/features/action-panel/faq)。相对 1.x 的增量见[新面板窗口常见问题](./new-main-win/faq.md)。
...
官网要求**不要同时安装** 1.x 和 V2（浏览器扩展会冲突）。需要回到 1.x 时，卸载 V2 后重新安装 1.x，不要覆盖 V2 数据目录。见 [从 V1 迁移](/v2/migration/from-v1.md)。
