---
title: "Photoshop控制"
description: "通过 Photoshop Bridge 调用宿主能力，包含连接验证、目标规则和使用限制。"
slug: "/v2/xaction/modules/photoshopcontrol"
sidebar_label: "Photoshop控制"
sidebar_position: 190
quickerDocKey: "xaction/module/sys:photoshopcontrol"
comments: true
moduleKey: "sys:photoshopcontrol"
docStatus: "reviewed"
...
使用前先[安装并连接 Photoshop Bridge](/v2/features/software-connections/software/photoshop)。本模块用于文档与图层、选择与图像处理、文件导出、UXP JavaScript；根据任务选择对应操作，或发送当前实例支持的自定义命令。

## 当前模块定义

<XActionModuleMeta moduleKey="sys:photoshopcontrol" />
...
文档与图层、选择与图像处理、文件导出、UXP JavaScript是常见使用方向。选择操作后填写对应字段；字段名称、默认值、枚举和条件以上方当前模块定义为准。
...
回到已连接的 Photoshop 窗口，再通过面板或配置好的快捷键触发动作。
...
- [Photoshop 安装与使用指南](/v2/features/software-connections/software/photoshop)
