...
2.2.6 起支持 **Mastercam 2024** 与 **Mastercam 2027**（Windows x64）。支持范围不等于所有小版本或全部产品线均已真机测试；实际可安装的年度与版本以设置页检测与软件卡片显示为准。更完整的发版说明见[官网版本记录](https://getquicker.net/V2/Versions)。
...
3. 在对应年度卡片（2024 或 2027）中点击安装、修复或卸载。两个年度使用各自的包和部署目录，一次安装不会覆盖另一个年度。
