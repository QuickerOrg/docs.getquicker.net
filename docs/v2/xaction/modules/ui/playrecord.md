...
metadataHash: "55d33607087351f2072355dabf7e01235264fd4a672c87ff169600c50dc76622"
legacyDocId: 3817323
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `data` | 录制数据 | `Text` |  | 是 | `UseVarOrInput` |  | 录制的键鼠操作数据 |
| `speed` | 重放速度 | `Number` | 2 | 是 | `UseVarOrInput` |  | 重放操作的速度 |
...
![](./img/playrecord-001-603a6a11e3.png)
